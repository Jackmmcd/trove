-- Daily spend ledger and cap for Ed.
...
CREATE TABLE IF NOT EXISTS ed_usage (
...
ALTER TABLE ed_usage DISABLE ROW LEVEL SECURITY;
...
CREATE OR REPLACE FUNCTION ed_record_usage(
  p_day DATE,
  p_input BIGINT,
  p_output BIGINT,
  p_cache_read BIGINT,
...
BEGIN
  INSERT INTO ed_usage AS u (day, turns, input_tokens, output_tokens, cache_read, cache_write, est_cost_usd, updated_at)
